 ...
 */
var i=void 0;i=function(){function e(){}return e.generate=function(){var t=e._getRandomInt,n=e._hexAligner;return n(t(32),8)+"-"+n(t(16),4)+"-"+n(16384|t(12),4)+"-"+n(32768|t(14),4)+"-"+n(t(48),12)},e._getRandomInt=function(e){return e<0?NaN:e<=30?0|Math.random()*(1<<e):e<=53?(0|Math.random()*(1<<30))+(0|Math.random()*(1<<e-30))*(1<<30):NaN},e._getIntAligner=function(e){return function(t,n){for(var i=t.toString(e),a=n-i.length,o="0";a>0;a>>>=1,o+=o)1&a&&(i=o+i);return i}},e._hexAligner=e._getIntAligner(16),e.prototype.toString=function(){return this.hexString},e}(),t.default=i},function(e,t,n){"use strict";function i(e){return e&&e.__esModule?e:{default:e}}function a(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(t,"__esModule",{value:!0});var o=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),r=n(0),s=i(r),u=n(3),l=i(u),f=n(4),d=i(f),c=n(1),h=i(c),v=function(){function e(t){a(this,e),this.tabs=[],this.config=t||{}}return o(e,[{key:"_remove",value:function(e){var t=void 0;t=l.default.searchByKeyName(this.tabs,"id",e.id,"index"),this.tabs.splice(t,1)}},{key:"_preProcessMessage",value:function(e){try{e=this.config.stringify(e)}catch(e){throw new Error(h.default.INVALID_JSON)}return e&&-1===e.indexOf(s.default.PARENT_COMMUNICATED)&&(e=s.default.PARENT_COMMUNICATED+e),e}},{key:"addNew",value:function(e){return this.tabs.push(e),this}},{key:"getOpened",value:function(){return this.tabs.filter(function(e){return e.status===d.default.OPEN})}},{key:"getClosed",value:function(){return this.tabs.filter(function(e){return e.status===d.default.CLOSE})}},{key:"getAll",value:function(){return this.tabs}},{key:"closeTab",value:function(e){var t=l.default.searchByKeyName(this.tabs,"id",e);return t&&t.ref&&(t.ref.close(),t.status=d.default.CLOSE),this}},{key:"closeAll",value:function(){var e=void 0;for(e=0;e<this.tabs.length;e++)this.tabs[e]&&this.tabs[e].ref&&(this.tabs[e].ref.close(),this.tabs[e].status=d.default.CLOSE);return this}},{key:"broadCastAll",value:function(e,t){var n=void 0,i=this.getOpened();for(e=this._preProcessMessage(e),n=0;n<i.length;n++)this.sendMessage(i[n],e,t);return this}},{key:"broadCastTo",value:function(e,t,n){var i=void 0,a=this.getAll();return t=this._preProcessMessage(t),i=l.default.searchByKeyName(a,"id",e),this.sendMessage(i,t,n),this}},{key:"sendMessage",value:function(e,t,n){var i=this.config.origin||"*";if(n&&e.ref[0])for(var a=0;a<e.ref.length;a++)e.ref[a].postMessage(t,i);else e.ref&&e.ref.top&&e.ref.top.postMessage(t,i)}},{key:"reset",value:function(){this.tabs=[]}}]),e}();t.default=v},function(e,t,n){"use strict";function i(e){return e&&e.__esModule?e:{default:e}}function a(e){var t={};return t._onLoad=function(t,n){var i=void 0,a=void 0,o=void 0,s=t.split(f.default.LOADED)[1];if(s)try{s=e.config.parse(s),s.id&&(a=e.getAll(),a.length&&(i=r.default.searchByKeyName(a,"id",s.id))&&(i.name=s.name||s.windowName))}catch(e){throw new Error(u.default.INVALID_JSON)}if(i||(a=e.getAll(),i=a.find(function(e){return e.ref===n})),!i&&n&&(a=e.getAll(),i=a.find(function(e){return e.ref===n})),i)try{o=f.default.HANDSHAKE_WITH_PARENT,o+=e.config.stringify({id:i.id,name:i.name||i.windowName,parentName:window.name}),e.sendMessage(i,o,s&&s.isSiteInsideFrame)}catch(e){throw new Error(u.default.INVALID_JSON)}},t._onCustomMessage=function(t,n){var i=void 0,a=void 0,o=t.split(n)[1];try{o=e.config.parse(o)}catch(e){throw new Error(u.default.INVALID_JSON)}a={tabInfo:o,type:n},i=new CustomEvent("onCustomChildMessage",{detail:a}),window.dispatchEvent(i)},t._onBeforeUnload=function(t){var n=t.split(f.default.ON_BEFORE_UNLOAD)[1];try{n=e.config.parse(n)}catch(e){throw new Error(u.default.INVALID_JSON)}var i=new CustomEvent("onChildUnload",{detail:n});window.dispatchEvent(i)},t.onNewTab=function(n){var i=n.source,a=n.data;return!(!a||"string"!=typeof a||!e.tabs.length)&&((!e.config.origin||e.config.origin===n.origin)&&void(a.indexOf(f.default.LOADED)>-1?t._onLoad(a,i):a.indexOf(f.default.CUSTOM)>-1?t._onCustomMessage(a,f.default.CUSTOM):a.indexOf(f.default.HANDSHAKE)>-1?t._onCustomMessage(a,f.default.HANDSHAKE):a.indexOf(f.default.ON_BEFORE_UNLOAD)>-1&&t._onBeforeUnload(a)))},t}Object.defineProperty(t,"__esModule",{value:!0});var o=n(3),r=i(o),s=n(1),u=i(s),l=n(0),f=i(l);n(11),t.default=a},function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=function(){function e(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=document.createEvent("CustomEvent");return n.initCustomEvent(e,!1,!1,t.detail),n}"function"!=typeof window.CustomEvent&&(e.prototype=window.Event.prototype,window.CustomEvent=e)}()},function(e,t,n){"use strict";function i(e){return e&&e.__esModule?e:{default:e}}function a(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(t,"__esModule",{value:!0});var o=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(e[i]=n[i])}return e},r=function(){function e(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,n,i){return n&&e(t.prototype,n),i&&e(t,i),t}}(),s=n(0),u=i(s),l=n(1),f=i(l),d=function(){function e(t){a(this,e),this.sessionStorageKey="__vwo_new_tab_info__",t||(t={}),void 0===t.handshakeExpiryLimit&&(t.handshakeExpiryLimit=5e3),void 0===t.shouldInitImmediately&&(t.shouldInitImmediately=!0),"function"!=typeof t.parse&&(t.parse=JSON.parse),"function"!=typeof t.stringify&&(t.stringify=JSON.stringify),this.tabName=window.name,this.tabId=null,this.tabParentName=null,o(this,t),this.config=t,this.shouldInitImmediately&&this.init()}return r(e,[{key:"_isSessionStorage",value:function(){try{return!!("sessionStorage"in window&&window.sessionStorage)}catch(e){return!1}}},{key:"_getData",value:function(){return!!this.isSessionStorageSupported&&window.sessionStorage.getItem(this.sessionStorageKey)}},{key:"_setData",value:function(e){return!!this.isSessionStorageSupported&&(window.sessionStorage.setItem(this.sessionStorageKey,e),e)}},{key:"_restoreData",value:function(){if(!this.isSessionStorageSupported)return!1;if(this.isSessionStorageSupported){var e=this._getData();this._parseData(e)}}},{key:"_parseData",value:function(e){var t=void 0;try{t=this.config.parse(e),this.tabId=t&&t.id,this.tabName=t&&t.name,this.tabParentName=t&&t.parentName}catch(e){throw new Error(f.default.INVALID_DATA)}}},{key:"onCommunication",value:function(e){var t=this,n=void 0,i=e.data;if(i&&"string"==typeof i&&(!this.config.origin||this.config.origin===e.origin)){if(window.clearTimeout(this.timeout),i.indexOf(u.default.PARENT_DISCONNECTED)>-1&&(this.config.onParentDisconnect&&this.config.onParentDisconnect(),window.removeEventListener("message",function(e){return t.onCommunication(e)})),i.indexOf(u.default.HANDSHAKE_WITH_PARENT)>-1){var a=void 0;n=i.split(u.default.HANDSHAKE_WITH_PARENT)[1],this._setData(n),this._parseData(n),a={id:this.tabId,isSiteInsideFrame:this.config.isSiteInsideFrame},this.sendMessageToParent(a,u.default.HANDSHAKE),this.config.onInitialize&&this.config.onInitialize()}if(i.indexOf(u.default.PARENT_COMMUNICATED)>-1){n=i.split(u.default.PARENT_COMMUNICATED)[1];try{n=this.config.parse(n)}catch(e){throw new Error(f.default.INVALID_JSON)}this.config.onParentCommunication&&this.config.onParentCommunication(n)}}}},{key:"addListeners",value:function(){var e=this;window.onbeforeunload=function(t){var n={id:e.tabId,isSiteInsideFrame:e.config.isSiteInsideFrame};e.sendMessageToParent(n,u.default.ON_BEFORE_UNLOAD)},window.removeEventListener("message",function(t){return e.onCommunication(t)}),window.addEventListener("message",function(t){return e.onCommunication(t)})}},{key:"setHandshakeExpiry",value:function(){var e=this;return window.setTimeout(function(){e.config.onHandShakeExpiry&&e.config.onHandShakeExpiry()},this.handshakeExpiryLimit)}},{key:"sendMessageToParent",value:function(e,t){var n=void 0;e=(t||u.default.CUSTOM)+this.config.stringify(e),window.top.opener&&(n=this.config.origin||"*",window.top.opener.postMessage(e,n))}},{key:"getTabInfo",value:function(){return{id:this.tabId,name:this.tabName,parentName:this.tabParentName,isSiteInsideFrame:this.config.isSiteInsideFrame}}},{key:"init",value:function(){this.isSessionStorageSupported=this._isSessionStorage(),this.addListeners(),this._restoreData(),this.sendMessageToParent(this.getTabInfo(),u.default.LOADED),this.timeout=this.setHandshakeExpiry(),this.config.onReady&&this.config.onReady()}}]),e}();t.default=d}])});